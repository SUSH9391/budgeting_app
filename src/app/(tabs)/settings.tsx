      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <NeoCard style={styles.settingsGroupCard}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
            onPress={() => Alert.alert('AI Voice Training', 'Voice recognition mode is calibrated and active.')}
          >
            <View style={styles.itemLeft}>
              <Ionicons name="mic-outline" size={20} color="#000" style={styles.itemIcon} />
          ...
          <View style={styles.settingItem}>
            <View style={styles.itemLeft}>
              <Ionicons name="shield-checkmark-outline" size={20} color="#000" style={styles.itemIcon} />
          ...
          <View style={styles.settingItem}>
            <View style={styles.itemLeft}>
              <Ionicons name="notifications-outline" size={20} color="#000" style={styles.itemIcon} />
          ...
          <TouchableOpacity
            style={styles.settingItem}
            activeOpacity={0.7}
            onPress={() => Alert.alert('Linked Banks', '2 Banks connected: Chase & Amex.')}
          >
            <View style={styles.itemLeft}>
              <Ionicons name="card-outline" size={20} color="#000" style={styles.itemIcon} />
              <Text style={styles.itemTitle}>LINKED BANKS</Text>
            </View>
            <View style={styles.connectedBadge}>
              <Text style={styles.connectedBadgeText}>{profile.linkedBanksCount} CONNECTED</Text>
            </View>
          </TouchableOpacity>
        </NeoCard>
